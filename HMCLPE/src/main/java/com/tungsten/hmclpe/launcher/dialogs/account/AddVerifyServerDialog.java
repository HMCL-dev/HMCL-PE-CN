...
public class AddVerifyServerDialog extends Dialog implements View.OnClickListener {
    ...
    public AddVerifyServerDialog(@NonNull Context context,OnAuthlibInjectorServerAddListener onAuthlibInjectorServerAddListener) {
        super(context);
