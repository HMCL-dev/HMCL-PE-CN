...
public class MKManager implements View.OnKeyListener, View.OnCapturedPointerListener {
    ...
    public boolean onCapturedPointer(View view, MotionEvent motionEvent) {
        if (menuHelper.gameCursorMode == 0) {
            ...
            menuHelper.pointerX += motionEvent.getX();
            menuHelper.pointerY += motionEvent.getY();
